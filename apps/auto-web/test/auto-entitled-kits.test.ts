/**
 * M6 Slice 3 — buyer entry point: the entitled-kit listing seam that backs the
 * "run on Auto" picker.
 *
 * Covers:
 ...
 *   • the GET /api/auto/entitled-kits route — cookie auth (401 unauth), gating on
 *     isMarketEnabled (empty when disabled), browser-safe passthrough.
 *
...
describe("GET /api/auto/entitled-kits route", () => {
  async function loadRoute() {
    return import("@/app/api/auto/entitled-kits/route");
  }
