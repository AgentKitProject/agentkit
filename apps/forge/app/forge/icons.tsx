...
// AgentKitForge brand mark — flat badge + line-art cube glyph (indigo +
// cyan-filled face). Flat 2D language shared with market (tile grid), auto
// (hexagon outline) and profile (avatar): rounded badge + accent stroke + a
// simple geometric glyph + one accent pop. The cube keeps Forge's heritage
// ("forge/build a kit") as the 2D analog of auto's outline hexagon.
export const ForgeMark = ({ size = 38, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <rect x="8" y="8" width="48" height="48" rx="14" fill="#EEF2FF" stroke="#4F46E5" strokeWidth="4" />
    {/* cyan front face, drawn behind the indigo edges so strokes stay crisp */}
    <path d="M32 33 L46 25 L46 39 L32 47 Z" fill="#06B6D4" />
    {/* cube silhouette */}
    <path d="M32 17 L46 25 L46 39 L32 47 L18 39 L18 25 Z" fill="none" stroke="#4F46E5" strokeWidth="3" strokeLinejoin="round" />
    {/* internal Y edges */}
    <path d="M18 25 L32 33 L46 25 M32 33 L32 47" fill="none" stroke="#4F46E5" strokeWidth="3" strokeLinejoin="round" strokeLinecap="round" />
  </svg>
);
