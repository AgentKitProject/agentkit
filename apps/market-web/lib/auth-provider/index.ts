...
//
// `lib/auth.ts` re-exports thin wrappers over the selected provider so the
// browser API routes / pages that consume `CurrentUser` keep working unchanged.
//
...
export type { AuthProvider, CurrentUser } from "./types.ts";
