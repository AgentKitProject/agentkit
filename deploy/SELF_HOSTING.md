...
| Chart | Image | Pin to |
|---|---|---|
| `agentkitmarket` (api/worker) | `ghcr.io/agentkitproject/agentkitmarket-core` | `v0.7.1` |
| `agentkitmarket` (web) | `ghcr.io/agentkitproject/agentkitmarket-app` | `v0.7.1` |
| `agentkitforge-web` (web) | `ghcr.io/agentkitproject/agentkitforge-web` | `v0.7.1` |
| `agentkitauto` (web) | `ghcr.io/agentkitproject/agentkitauto-app` | `v0.7.1` |
| `agentkitauto` (worker) | `ghcr.io/agentkitproject/agentkitauto-worker` | `v0.7.1` |
...
`version=v0.7.1`), which promotes one of those already-built builds to the `vX.Y.Z`
...
example below overrides them to `v0.7.1`.
...
auto:
  enabled: true
  workerImage: "ghcr.io/agentkitproject/agentkitauto-worker:v0.7.1"
