...
| Chart | Image | Pin to |
|---|---|---|
| `agentkitmarket` (api/worker) | `ghcr.io/agentkitproject/agentkitmarket-core` | `v0.2.4` |
| `agentkitmarket` (web) | `ghcr.io/agentkitproject/agentkitmarket-app` | `v0.2.4` |
| `agentkitforge-web` (web) | `ghcr.io/agentkitproject/agentkitforge-web` | `v0.2.4` |
| `agentkitauto` (web) | `ghcr.io/agentkitproject/agentkitauto-app` | `v0.2.4` |
| `agentkitauto` (worker) | `ghcr.io/agentkitproject/agentkitauto-worker` | `v0.2.4` |
...
`version=v0.2.4`), which promotes one of those already-built builds to the `vX.Y.Z`
...
auto:
  enabled: true
  workerImage: "ghcr.io/agentkitproject/agentkitauto-worker:v0.2.4"
