...
Common labels
*/}}
{{- define "agentkitforge.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name .Chart.Version | quote }}
app.kubernetes.io/name: {{ include "agentkitforge.name" . }}
...
Selector labels — web
*/}}
{{- define "agentkitforge.selectorLabelsWeb" -}}
app.kubernetes.io/name: {{ include "agentkitforge.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
...
Web ConfigMap name
*/}}
{{- define "agentkitforge.webConfigmapName" -}}
{{ include "agentkitforge.fullname" . }}-config
{{- end }}

{{/*
Web Secret name (chart-managed)
*/}}
{{- define "agentkitforge.webSecretName" -}}
{{ include "agentkitforge.fullname" . }}-secret
{{- end }}

{{/*
Effective web Secret name — the existing Secret if provided, else chart-managed.
*/}}
{{- define "agentkitforge.webEffectiveSecretName" -}}
{{- if .Values.web.secrets.existingSecret -}}
{{ .Values.web.secrets.existingSecret }}
{{- else -}}
{{ include "agentkitforge.webSecretName" . }}
{{- end -}}
{{- end }}
...
*/}}
{{- define "agentkitforge.postgresHost" -}}
{{ include "agentkitforge.fullname" . }}-postgres
{{- end }}
...
Usage: {{ include "agentkitforge.resolveSecret" (dict "ctx" $ "given" .Values.x "key" "FOO" "gen" "rand32") }}
...
*/}}
{{- define "agentkitforge.resolveSecret" -}}
{{- $ctx := .ctx -}}
{{- $given := .given | default "" -}}
{{- if $given -}}
{{- $given -}}
{{- else -}}
{{- $secretName := include "agentkitforge.webSecretName" $ctx -}}
...
*/}}
{{- define "agentkitforge.minioEndpoint" -}}
http://{{ include "agentkitforge.fullname" . }}-minio:9000
{{- end }}
